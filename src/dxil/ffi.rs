...
com_interface! {
    interface ID3D12ShaderReflectionConstantBuffer: IUnknown {
        ...
        fn get_variable_by_index(index: u32) -> ComPtr<ID3D12ShaderReflectionVariable>;
        fn get_variable_by_name(name: LPCSTR) -> ComPtr<ID3D12ShaderReflectionVariable>;
    }
}
...
com_interface! {
    interface ID3D12LibraryReflection: IUnknown {
        ...
        fn get_function_by_index(function_index: i32) -> ComPtr<ID3D12FunctionReflection>;
    }
}
...
com_interface! {
    interface ID3D12FunctionReflection: IUnknown {
        ...
        fn get_constant_buffer_by_index(buffer_index: u32) -> ComPtr<ID3D12ShaderReflectionConstantBuffer>;
        fn get_constant_buffer_by_name(name: LPCSTR) -> ComPtr<ID3D12ShaderReflectionConstantBuffer>;
        fn get_desc(p_desc: *mut d3d12shader::D3D12_FUNCTION_DESC) -> HRESULT;
        fn get_function_parameter(parameter_index: i32) -> ComPtr<ID3D12FunctionParameterReflection>;
...
com_interface! {
    interface ID3D12ShaderReflectionType: IUnknown {
        ...
        fn get_base_class() -> ComPtr<ID3D12ShaderReflectionType>;
        fn get_desc(p_desc: *mut d3d12shader::D3D12_SHADER_TYPE_DESC) -> HRESULT;
        fn get_interface_by_index(index: u32) -> ComPtr<ID3D12ShaderReflectionType>;
        fn get_member_type_by_index(index: u32) -> ComPtr<ID3D12ShaderReflectionType>;
        fn get_member_type_by_name(name: LPCSTR) -> ComPtr<ID3D12ShaderReflectionType>;
        fn get_member_type_name(index: u32) -> LPCSTR;
        fn get_num_interfaces() -> u32;
        fn get_sub_type() -> ComPtr<ID3D12ShaderReflectionType>;
        fn implements_interface(p_base: ComPtr<ID3D12ShaderReflectionType>) -> HRESULT;
        fn is_equal(p_desc: ComPtr<ID3D12ShaderReflectionType>) -> HRESULT;
        fn is_of_type(p_desc: ComPtr<ID3D12ShaderReflectionType>) -> HRESULT;
    }
}
...
com_interface! {
    interface ID3D12ShaderReflection: IUnknown {
        ...
        fn get_constant_buffer_by_index(index: u32) -> ComPtr<ID3D12ShaderReflectionConstantBuffer>;
        fn get_constant_buffer_by_name(name: LPCSTR) -> ComPtr<ID3D12ShaderReflectionConstantBuffer>;
