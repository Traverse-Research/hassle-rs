...
com_interface! {
    interface ID3D12ShaderReflectionConstantBuffer: IUnknown {
        ...
        fn get_variable_by_name(name: LPCSTR) -> ID3D12ShaderReflectionVariable;
    }
}
...
com_interface! {
    interface ID3D12LibraryReflection: IUnknown {
        ...
        fn get_function_by_index(function_index: i32) -> ID3D12FunctionReflection;
    }
}
...
com_interface! {
    interface ID3D12FunctionReflection: IUnknown {
        ...
        fn get_constant_buffer_by_name(name: LPCSTR) -> ID3D12ShaderReflectionConstantBuffer;
...
com_interface! {
    interface ID3D12ShaderReflectionType: IUnknown {
        ...
        fn get_base_class() -> ID3D12ShaderReflectionType;
        ...
        fn get_member_type_by_name(name: LPCSTR) -> ID3D12ShaderReflectionType;
        ...
        fn is_equal(p_desc: ID3D12ShaderReflectionType) -> HRESULT;
        fn is_of_type(p_desc: ID3D12ShaderReflectionType) -> HRESULT;
    }
}
